import 'package:csvtu_e_books/main.dart';
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage(
                  "assets/Images/309d9569-bdb2-4fd2-9e6d-ddd67c61acdc.jpg"),
              fit: BoxFit.fill,
            ),
          ),
          child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(
                  width: MediaQuery.of(context).size.width * .8,
                  child: RoundedButton(
                    text: "ELECTRICAL & ELECTRONICS ENGG",
                    fontsize: 16,
                    press: () {
                      Navigator.push(
                        context,
